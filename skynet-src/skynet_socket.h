...
int skynet_socket_send_udp(struct skynet_context *ctx, int id, void *buffer, int sz,char *peer_ip,int peer_port);
...
int skynet_socket_connect_udp(struct skynet_context *ctx, const char *host, int port);
